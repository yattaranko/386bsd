 ...
 *  October 1992
 *
 * $Id: dosfs_vnops.c,v 1.1 94/10/19 23:46:53 bill Exp $
 */
 ...
 */
	if (newparent == 0) {
		...
		(void)memcpy(ep->deName, toname, 11);
 ...
 */
	...
	memset(bp->b_un.b_addr, 0, pmp->pm_bpcluster);
	/*bzero(bp->b_un.b_addr, pmp->pm_bpcluster);*/
	(void)memcpy(bp->b_un.b_addr, &dosdirtemplate, sizeof dosdirtemplate);
 ...
 */
	ndep = &ndirent;
	(void) memset(ndep, 0, sizeof(*ndep));
